  ...
  describe("Zagnieżdżone elementy", () => {
    test("renderuje zagnieżdżone elementy z poprawnymi poziomami", () => {
      ...
      const parentElement = screen
        ...
        .closest('[data-testid="data-test-level-0"]');
      const childElement = screen
        .getByText("Child Item 1")
        .closest('[data-testid="data-test-level-1"]');
      const grandchildElement = screen
        .getByText("Grandchild Item 1")
        .closest('[data-testid="data-test-level-2"]');
  ...
  describe("Stany specjalne", () => {
    ...
    test("obsługuje maksymalny poziom zagnieżdżenia", () => {
      ...
      const addChildButton =
        within(level5Element).getByText("Dodaj pozycję menu");
